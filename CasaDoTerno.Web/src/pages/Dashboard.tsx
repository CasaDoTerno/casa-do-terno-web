...
export function Dashboard() {
  ...
  useEffect(() => {
    // Agenda de Hoje e Atrasados dependem disso — todo mundo precisa
    carregarLocacoes();
    api.get<Cliente[]>("/Clientes").then((r) => setClientes(r.data));

    // tudo abaixo é informação financeira/gerencial — só busca se for Admin,
    // evitando chamadas que dariam 401/403 pra Vendedor (o Controller já é Admin-only)
    if (!admin) return;
